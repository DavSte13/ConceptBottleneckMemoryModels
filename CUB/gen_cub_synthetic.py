...
if __name__ == '__main__':
    ...
    parser.add_argument('-cub_dir', default='data_CUB/CUB_200_2011', help='Path to CUB (should also contain segmentations folder)')
    parser.add_argument('-places_dir', default='data_CUB/places365', help='Path to Places365 dataset')
